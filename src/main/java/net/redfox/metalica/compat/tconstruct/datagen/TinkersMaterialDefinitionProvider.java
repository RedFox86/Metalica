...
public class TinkersMaterialDefinitionProvider
    extends slimeknights.tconstruct.library.data.material.AbstractMaterialDataProvider {
  ...
  protected void addMaterials() {
    for (MetalMaterial material : MetalMaterial.getMaterials()) {
      ...
      addMaterial(
          new slimeknights.tconstruct.library.materials.definition.MaterialId(
    ...
    for (String name : MetalMaterial.getToRemove()) {
      addMaterial(
          new slimeknights.tconstruct.library.materials.definition.MaterialId(
              ResourceLocation.fromNamespaceAndPath("tconstruct", name)),
          0,
          5,
          false,
          true,
